class Colour {
    ...
    setLocked (locked) {
        ...
        if (locked) {
            ...
            this.element.querySelector(".lock-toggle").classList.add("is-lockeed");
            this.element.querySelector('img').src = 'lock.svg';
        }
        else {
            // this.element.classList.remove('locked');
            this.element.querySelector(".lock-toggle").classList.remove("is-locked");
            this.element.querySelector('img').src = 'icons8-lock.svg';
        }
    }
